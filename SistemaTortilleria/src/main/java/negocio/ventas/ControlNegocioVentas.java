...
public class ControlNegocioVentas {
    ...
    public boolean confirmarVenta(List<dtos.DetalleVentaDTO> carrito, dtos.ClienteDTO cliente, double efectivo) { 
        return gestor.procesarVenta(carrito, cliente, efectivo); 
    }
